...
class PromptConfig(BaseModel):
    ...
    """When True, backstory is generated from Lore Library data instead of the manual text above."""

    lore_universe_id: Optional[str] = None
    """The UUID of the Lore Library universe this Wingman belongs to."""

    lore_character_id: Optional[str] = None
    """The UUID of the character this Wingman embodies in the Lore Library."""
...
class LoreUniverseCreate(BaseModel):
    name: str
    description: Optional[str] = None


class LoreUniverseUpdate(BaseModel):
    name: Optional[str] = None
    description: Optional[str] = None


class LorePersonalityAxis(BaseModel):
    id: str
    character_id: str
    axis_name: str
...
class LorePersonalityAxisCreate(BaseModel):
    axis_name: str
    value: int = Field(ge=1, le=10)
    note: Optional[str] = None
...
class LoreCharacter(BaseModel):
    ...
    backstory_text: Optional[str] = None
    secrets: Optional[str] = None
    directives: Optional[str] = None
    free_notes: Optional[str] = None
    created_at: str
    updated_at: str
    personality_axes: list[LorePersonalityAxis] = []
...
class LoreCharacterCreate(BaseModel):
    ...
    directives: Optional[str] = None
    free_notes: Optional[str] = None
    personality_axes: list[LorePersonalityAxisCreate] = []


class LoreCharacterUpdate(BaseModel):
    name: Optional[str] = None
    nickname: Optional[str] = None
    gender: Optional[str] = None
    age: Optional[str] = None
...
class LoreCodexEntry(BaseModel):
    id: str
    universe_id: str
    title: str
...
class LoreCodexEntryCreate(BaseModel):
    title: str
    category: Optional[str] = None
    content: str
    tags: Optional[str] = None
...
class LoreCodexEntryUpdate(BaseModel):
    title: Optional[str] = None
    category: Optional[str] = None
...
class LoreRelationshipCreate(BaseModel):
    source_type: str
    source_id: str
    target_type: str
    target_id: str
...
class LoreRelationshipUpdate(BaseModel):
    relationship_type: Optional[str] = None
    description: Optional[str] = None
...
class MigrateBackstoryResponse(BaseModel):
    characters: list[LoreCharacterCreate]
    codex_entries: list[LoreCodexEntryCreate]
    relationships: list[LoreRelationshipCreate]
    warnings: list[str]
