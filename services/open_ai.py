...
class OpenAi:
    ...
    def _handle_api_error(self, api_response):
        ...
        match api_response.status_code:
            ...
            case 404:
                Printr.info_print("The key you are using might not be eligible for the gpt-4 model.", False)
                Printr.info_print("Access to gpt-4 is granted, after you spent at least 1$ on your Open AI account.", False)
                Printr.info_print("Have a look at our Discord 'early-access' channel for more information on that topic.", False)
            case _:
                pass # ¯\_(ツ)_/¯
