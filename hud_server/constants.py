...
LOG_SERVER_STARTUP_TIMEOUT = "Failed to start within {}s timeout"
LOG_SERVER_ALREADY_RUNNING = "Server already running"
LOG_OVERLAY_STARTED = "Overlay renderer started"
LOG_OVERLAY_STOPPED = "Overlay renderer stopped"
LOG_OVERLAY_NOT_AVAILABLE = "Overlay not available (PIL or HeadsUpOverlay missing)"
LOG_OVERLAY_ALREADY_RUNNING = "Overlay already running"
