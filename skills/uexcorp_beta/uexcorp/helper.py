...
class Helper:
    ...
    def __init__(self):
        ...
        self.__data_path: str = get_writable_dir(path.join("skills", "uexcorp_beta", "data")) # TODO change back to uexcorp
        self.__version_file_path: str = get_writable_dir(path.join("skills", "uexcorp_beta")) # TODO change back to uexcorp
