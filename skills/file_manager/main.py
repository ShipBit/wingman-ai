    ...
    async def execute_tool(
        ...
        if tool_name in [
            ...
            if self.settings.debug_mode:
                message = f"File Manager: executing tool '{tool_name}'"
                if parameters:
            ...
            if tool_name == "load_text_from_file":
                    ...
                    if file_extension.lower() not in self.allowed_file_extensions:
                        ...
                        try:
                            ...
                            file_content = self.get_text_from_file(
                                file_path, file_extension, pdf_page_number
                            )
                            ...
                            function_response = (
                                f"File '{file_name}' not found in '{directory_path}'."
                            )
                        except Exception as e:
                            function_response = (
                            ...
                            if (
                                ...
                                try:
                                    ...
                                    if len(file_content) < 3 or not file_content:
                                        ...
                                        function_response = (
                                            f"File content from {file_path} read aloud."
                                        )
                                except Exception as e:
                ...
                try:
                    ...
                    for file_path in absolute_paths:
                        ...
                        if file_extension.lower() not in self.allowed_file_extensions:
                            ...
                            file_contents = self.get_text_from_file(
                    ...
                    function_response = (
                        f"Error in reading folder contents in '{folder_path}': {str(e)}"
                    )
                ...
                try:
                    ...
                    with zipfile.ZipFile(
                        full_zip_path, "w", zipfile.ZIP_DEFLATED
                    ) as zip_ref:
                    ...
                    function_response = (
                        f"Created zip file '{full_zip_path}' with specified files."
                    )
                except Exception as e:
                    function_response = (
                        f"Failed to create zip file '{zip_file_name}': {str(e)}"
                    )
                ...
                try:
                    ...
                    with zipfile.ZipFile(
                        full_zip_path, "a", zipfile.ZIP_DEFLATED
                    ) as zip_ref:
                    ...
                    function_response = (
                        f"Added specified files to zip file '{full_zip_path}'."
                    )
                except Exception as e:
                    function_response = (
                        f"Failed to add files to zip file '{full_zip_path}': {str(e)}"
                    )
                ...
                try:
                    with zipfile.ZipFile(zip_file_path, "r") as zip_ref:
                        ...
                        function_response = (
                            f"Extracted {zip_file_path} contents to {target_directory}"
                        )

                except Exception as e:
                    function_response = (
                        f"Failed to extract contents of {zip_file_path}, error was {e}."
                    )

            if self.settings.debug_mode:
                await self.printr.print_async(
                    f"File Manager: finished '{tool_name}' tool with response: '{function_response}'",
                    color=LogType.INFO,
                )
